<?php
    ...
    $movies = [
        ...
        [
            ...
            "vote" => 4,
            "genre" => "horror",
            "year_release" => "19-12-1975",
            "plot" => "Nei giorni che precedono la Festa del 4 luglio, la giovane Christine Watkins, scompare dopo essersi tuffata in mare per un bagno di mezzanotte. Il giorno seguente viene rinvenuto sulla battigia il corpo senza vita della ragazza. Le profonde lacerazioni presenti nel corpo martoriato sono compatibili con un attacco di uno squalo.
